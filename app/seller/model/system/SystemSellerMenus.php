 ...
 */
class SystemSellerMenus extends BaseModel
{
    /**
     * 数据表主键
     * @var string
     ...
     * @var string
     */
    protected $name = 'system_seller_menus';
     ...
     * @throws \think\exception\DbException
     */
    public static function rolesByRuleList(string $rules)
    {
        $res = SystemSellerRole::where('id', 'IN', $rules)->field('GROUP_CONCAT(rules) as ids')->find();
    ...
    {
        return strtolower($module . '/' . $controller . '/' . $action . '/' . SystemSellerMenus::paramStr($route));
    }
