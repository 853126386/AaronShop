...
use app\seller\model\system\SystemStore as StoreModel;
use crmeb\services\FormBuilder as Form;
use crmeb\services\JsonService;
use crmeb\services\JsonService as Json;
use app\seller\model\system\SystemStoreStaff as StaffModel;
use app\seller\model\system\SystemStore;
...
//                $menus[] = ['value' => 0, 'label' => '顶级分类'];
    ...
    {
        return Json::successlayui(StaffModel::getUserList());
    }
