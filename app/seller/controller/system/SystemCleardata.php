...
class SystemclearData extends AuthController
{
    ...
    public function undata($type = 1)
    {
        switch ((int)$type) {
            case 1:
                $fileImage = \app\seller\model\system\SystemAttachment::where('module_type', 2)->field(['att_dir', 'satt_dir'])->select();
                ...
                \app\seller\model\system\SystemAttachment::where('module_type', 2)->delete();
